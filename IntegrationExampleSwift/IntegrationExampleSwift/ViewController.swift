...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        trxhostsSDK.presentPayment(at: self, paymentInfo: paymentInfo) { (result) in
            print("trxhostsSDK finished with status \(result.status.rawValue)")

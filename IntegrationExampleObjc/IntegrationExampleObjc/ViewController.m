...
@property (nonatomic, strong) ODTPaySDK *odtSDK;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.odtSDK = [[ODTPaySDK alloc] init];
    ...
    [self.odtSDK presentPaymentAt:self paymentInfo:paymentInfo completionHandler:^(ODTPaymentResult *result) {

...
//  Copyright © 2019 TrxHosts. All rights reserved.
//
...
@property (nonatomic, strong) TrxhostsSDK *trxhostsSDK;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.trxhostsSDK = [[TrxhostsSDK alloc] init];
    ...
    [self.trxhostsSDK presentPaymentAt:self paymentInfo:paymentInfo completionHandler:^(TrxhostsPaymentResult *result) {
        NSLog(@"trxhostsSDK finished with status %ld", (long)result.status);
